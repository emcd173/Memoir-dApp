...
By creating a decentralized time-capsule protocol that deterministically locks any digital asset for a period of time, we: 
  ...
  3. <b>Connect</b> encrypted, content-permanent web objects to an ethereum-driven timelock mechanism

Memoir is a novel approach to time-locking secrets.  We built the protocol because of the social need for reliable digital timelocked obfuscation and preservation technique.  We also see real economic value in removing costs associated with third-party custodians and the risk of them defaulting on a promise or contract.

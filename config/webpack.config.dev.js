...
// Tracing deprecations so we can continueally update packages outdated
...
module.exports = {
  ...
  module: {
    rules: [
        ...
        use: [
          ...
          {loader: 'sass-loader', options: {
            ...
            includePaths: [
              ...
              paths.path.join(__dirname, '..', 'src', 'styles', 'sass')
            ]}
          }
        ]
      },
      ...
      // In webpack 2 + json is supported
      // {
      //   test: /\.json$/,
      //   loader: 'json'
      // },
  ...
  // Need to remove this for webpack 2 upgrade. Replaced with options parameter in postcss-loader rule
  // postcss: function() {
  //   return [
  //     autoprefixer({
  //       browsers: [
